USE [master]
GO
/****** Object:  Database [test1]    Script Date: 22.06.2022 17:56:27 ******/
CREATE DATABASE [test1]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'test1', FILENAME = N'C:\Users\RX Group\test1.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'test1_log', FILENAME = N'C:\Users\RX Group\test1_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
USE [test1]
GO
/****** Object:  Table [dbo].[Book]    Script Date: 22.06.2022 17:56:27 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Customer]    Script Date: 22.06.2022 17:56:27 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[RecordOwn]    Script Date: 22.06.2022 17:56:27 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[RecordOwn](
	[Id] [int] IDENTITY(1,1) NOT NULL,
	[CustomerId] [int] NOT NULL,
	[BookId] [int] NOT NULL,
	[DeliveryDate] [datetime2](7) NOT NULL,
	[ReturnDate] [datetime2](7) NULL,
 CONSTRAINT [PK_RecordOwn] PRIMARY KEY CLUSTERED 
(
	[Id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
GO
ALTER TABLE [dbo].[Book] ADD  CONSTRAINT [DF_Book_CreateAt]  DEFAULT (getdate()) FOR [CreateAt]
GO
ALTER TABLE [dbo].[Customer] ADD  CONSTRAINT [DF_Customer_CreateAt]  DEFAULT (getdate()) FOR [CreateAt]
GO
ALTER TABLE [dbo].[Book]  WITH CHECK ADD  CONSTRAINT [FK_Book_Customer] FOREIGN KEY([CurrentOwn])
REFERENCES [dbo].[Customer] ([CustomerId])
GO
ALTER TABLE [dbo].[Book] CHECK CONSTRAINT [FK_Book_Customer]
GO
ALTER TABLE [dbo].[RecordOwn]  WITH CHECK ADD  CONSTRAINT [FK_RecordOwn_Book] FOREIGN KEY([BookId])
REFERENCES [dbo].[Book] ([BookId])
GO
ALTER TABLE [dbo].[RecordOwn] CHECK CONSTRAINT [FK_RecordOwn_Book]
GO
ALTER TABLE [dbo].[RecordOwn]  WITH CHECK ADD  CONSTRAINT [FK_RecordOwn_Customer] FOREIGN KEY([CustomerId])
REFERENCES [dbo].[Customer] ([CustomerId])
GO
ALTER TABLE [dbo].[RecordOwn] CHECK CONSTRAINT [FK_RecordOwn_Customer]
GO
USE [master]
GO
